...
Revision History:
    ...
    13/03/01    awm     Created.
        ...
        12/06/03	awm		Added FT_StopInTask and
FT_RestartInTask. 18/09/03	awm		Added FT_SetResetPipeRetryCount.
...
FTD2XX_API
FT_STATUS WINAPI FT_Read(FT_HANDLE ftHandle, LPVOID lpBuffer, DWORD nBufferSize,
